...
export const services: Service[] = [
  ...
  },
  {
    ...
    steps: documentFlow,
    verificationNote: 'Book-scanning equipment, handling controls and supported specifications require owner confirmation.',
  ...
  },
  {
    ...
    steps: mediaFlow,
    verificationNote: 'Accepted microfilm and microfiche types, equipment and quality-control process require owner confirmation.',
    image: legacyMedia,
  ...
  },
  {
    ...
    steps: documentFlow,
    verificationNote: 'Supported languages, OCR/ICR software, accuracy levels and validation methods require owner confirmation.',
    image: informationSystems,
    imageAlt: 'Illustrative monitor showing document recognition and searchable archive interfaces',
    icon: ScanText,
    featured: true,
  },
  {
