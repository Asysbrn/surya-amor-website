...
export default function HomePage() {
  ...
  return <><HomeHero /><IntroductionSection /><ServicesSection /><FormatCoverageSection /><IndustriesSection /><WhySection /><ProcessSection /><NewsSection /><ClientsSection /><ContactPreviewSection /></>
}
